...
export default function EmployeesPage() {
  ...
  async function load() {
    try {
      const d = await api.get<{ employees: Employee[] }>("/admin/employees");
  ...
  async function save() {
    ...
    setMsg(null);
    try {
      await api.patch(`/admin/employees/${openEmployee.id}`, {
        name: form.name.trim(),
  ...
  async function remove(e: Employee) {
    ...
    try {
      ...
      // no-op: matches original behavior of silently ignoring delete failures
    }
  }
